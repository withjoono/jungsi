 ...
 *
 * 사용법: node crawl-final-rates-to-excel-v14.js
 */
...
async function main() {
  ...
  console.log('╔══════════════════════════════════════════════════════════════╗');
  console.log('║   정시 경쟁률 크롤러 v14 - 완전한 rowspan 처리               ║');
  console.log('╠══════════════════════════════════════════════════════════════╣');
  ...
  saveToExcel(allData, path.join(outputDir, `최종경쟁률_v14_${dateStr}_${timeStr}.xlsx`));
  ...
  saveToExcel(summaryData, path.join(outputDir, `최종경쟁률_요약_v14_${dateStr}_${timeStr}.xlsx`), '대학별요약');

  if (CONFIG.LOG_ERRORS_TO_FILE && allErrors.length > 0) {
    saveErrorLog(allErrors, path.join(outputDir, `크롤링에러_v14_${dateStr}_${timeStr}.xlsx`));
  }
