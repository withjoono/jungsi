...
import {
  DataTable,
  IExploreEarlyComprehensiveStep2ItemWithMyScores,
} from "./data-table";
...
import { useGetExploreEarlyComprehensiveStep2 } from "@/stores/server/features/explore/early-comprehensive/queries";
...
export const EarlyComprehensiveStep2 = () => {
  ...
  // Queries
  const { data: susiComprehensiveStep2 } = useGetExploreEarlyComprehensiveStep2(
  ...
  const dataWithMyScore = susiComprehensiveStep2?.items.map((n) => {
    ...
    } as IExploreEarlyComprehensiveStep2ItemWithMyScores;
  });
