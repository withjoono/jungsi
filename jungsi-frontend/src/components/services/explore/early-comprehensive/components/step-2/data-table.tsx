...
import { IExploreEarlyComprehensiveStep2Item } from "@/stores/server/features/explore/early-comprehensive/interfaces";
...
export type IExploreEarlyComprehensiveStep2ItemWithMyScores =
  IExploreEarlyComprehensiveStep2Item & {
    myScores: {
      items: {
        text: string;
        score: number;
...
interface DataTableProps {
  className?: string;
  data: IExploreEarlyComprehensiveStep2ItemWithMyScores[];
  selectedIds: number[];
...
export const DataTable = ({
  ...
  const onClick = (item: IExploreEarlyComprehensiveStep2ItemWithMyScores) => {
  ...
  const checkSelectedItem = (
    item: IExploreEarlyComprehensiveStep2ItemWithMyScores,
  ) => {
