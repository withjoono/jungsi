...
import { IExploreEarlyComprehensiveStep3Item } from "@/stores/server/features/explore/early-comprehensive/interfaces";
import { IMockExamScore } from "@/stores/server/features/mock-exam/interfaces";
import { useState } from "react";

interface DataTableProps {
  className?: string;
  data: IExploreEarlyComprehensiveStep3Item[];
  selectedIds: number[];
...
export const DataTable = ({
  ...
  const onClick = (item: IExploreEarlyComprehensiveStep3Item) => {
  ...
  const checkSelectedItem = (item: IExploreEarlyComprehensiveStep3Item) => {
