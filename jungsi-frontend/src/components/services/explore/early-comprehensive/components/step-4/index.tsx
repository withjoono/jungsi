...
import { useGetExploreEarlyComprehensiveStep4 } from "@/stores/server/features/explore/early-comprehensive/queries";
import { EarlyComprehensiveReport } from "@/components/reports/early-comprehensive-report";
import { useGetInterestRecruitmentUnits } from "@/stores/server/features/susi/interest-univ/queries";

export const EarlyComprehensiveStep4 = () => {
  const { prevStep, nextStep, formData, updateFormData } =
    useExploreEarlyComprehensiveStepper();

  const susiComprehensiveStep4 = useGetExploreEarlyComprehensiveStep4(
  ...
  if (selectedComprehensiveId) {
    return (
      <div className="space-y-6">
        ...
        <EarlyComprehensiveReport
          earlyComprehensiveId={selectedComprehensiveId}
