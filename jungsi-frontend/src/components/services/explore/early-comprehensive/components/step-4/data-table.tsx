...
import { IExploreEarlyComprehensiveStep4Item } from "@/stores/server/features/explore/early-comprehensive/interfaces";
import { useState } from "react";

interface DataTableProps {
  className?: string;
  data: IExploreEarlyComprehensiveStep4Item[];
  selectedIds: number[];
...
export const DataTable = ({
  ...
  const onClick = (item: IExploreEarlyComprehensiveStep4Item) => {
  ...
  const checkSelectedItem = (item: IExploreEarlyComprehensiveStep4Item) => {
