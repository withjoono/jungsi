...
import { IExploreEarlySubjectStep5Item } from "@/stores/server/features/explore/early-subject/interfaces";

interface DataTableProps {
  className?: string;
  data: IExploreEarlySubjectStep5Item[];
  selectedIds: number[];
...
export const DataTable = ({
  ...
  const onClick = (item: IExploreEarlySubjectStep5Item) => {
  ...
  const checkSelectedItem = (item: IExploreEarlySubjectStep5Item) => {
