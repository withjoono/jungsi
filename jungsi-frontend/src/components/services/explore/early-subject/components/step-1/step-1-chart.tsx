...
interface Step1Props {
  ...
  onClickItem: (item: IExploreEarlySubjectStep1Item | string) => void;
  checkSelectedItem: (item: IExploreEarlySubjectStep1Item | string) => boolean;
}
        ...
        <Tooltip
          ...
          content={({ active, payload }) => {
            ...
            const university_name =
              payload?.[0]?.payload?.university.name ?? "";
